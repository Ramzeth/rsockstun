...
Main difference from main branch - server and client uses HTTP request/response to auth. So powershell client can use system proxy and current logon user credentials.
...
powershell_cleint.ps1 script uses system proxy and current logon user credentials to authorize on proxy server.
